...
import PaymentForm from "./pages/VendorPayoutForm";
    ...
    <>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            path="/returnsexchangepolicy"
            element={<ReturnsExchangePolicy />}
          />
          <Route
            path="/returnexchangerequest"
            element={<ReturnExchangeRequest />}
          />
          <Route path="/venderpayment" element={<PaymentForm />} />
          ...
          <Route path="/cancellaion_policy" element={<CancellationPolicy />} />
